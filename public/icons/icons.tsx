...
export type IconName = "home" | "tracks" | "pilots" | "f1" | "loading" | "teams"
...
export const icons = {
    ...
    car: <Icon icon="teams" className="w-[24px] rotate-y-180" />,
}
...
function Teams({className}: {className?: string}) {
    return (
        <svg
            version="1.0"
            ...
            className={className}
        >
            <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="currentColor" strokeWidth={"8px"}>
                <path
                    d="M901 4919 c-72 -13 -152 -37 -172 -52 -25 -19 -41 -56 -33 -80 3 -12
108 -124 232 -250 l227 -227 -180 -180 -179 -180 -232 230 c-205 204 -234 230
-263 230 -51 0 -76 -37 -102 -146 -18 -79 -21 -114 -17 -226 4 -115 9 -146 36
-228 95 -286 326 -501 614 -570 104 -25 273 -27 373 -4 39 9 81 18 95 21 23 4
70 -39 383 -348 197 -193 356 -356 355 -360 -2 -5 -161 -170 -355 -367 l-351
-359 -89 23 c-118 31 -292 32 -410 4 -460 -110 -746 -592 -623 -1049 16 -59
29 -87 47 -101 53 -42 61 -36 310 212 l233 233 183 -183 182 -182 -233 -228
c-208 -202 -234 -231 -234 -260 -1 -17 7 -41 17 -52 36 -40 188 -73 330 -73
550 2 953 530 815 1068 l-20 80 360 360 360 360 364 -364 363 -363 -19 -60
c-39 -128 -38 -337 2 -472 67 -220 233 -417 437 -520 141 -71 318 -104 468
-87 175 20 255 59 255 124 0 26 -32 62 -230 261 l-230 232 180 179 180 180
223 -222 c122 -122 233 -226 247 -231 35 -13 78 4 95 37 50 98 58 371 15 521
-84 292 -321 521 -618 596 -128 33 -289 33 -414 1 l-87 -23 -233 236 c-128
129 -289 292 -358 363 l-125 127 360 361 c313 313 363 359 385 356 14 -3 58
-12 99 -21 106 -24 274 -22 376 4 159 41 296 121 412 243 89 94 154 203 195
327 26 81 31 115 36 227 6 162 -20 303 -65 347 -54 55 -63 49 -317 -204 l-232
-230 -179 181 -180 180 222 219 c123 120 227 229 232 242 33 89 -96 143 -339
142 -116 -1 -147 -5 -223 -28 -286 -86 -488 -280 -583 -558 -50 -148 -55 -327
-14 -477 l21 -73 -250 -256 c-137 -142 -299 -306 -360 -367 l-111 -110 -364
364 -363 363 18 59 c92 294 1 634 -227 850 -107 100 -236 173 -376 210 -85 23
-268 33 -347 18z m315 -170 c185 -46 350 -177 436 -344 94 -183 108 -359 44
-559 -19 -60 -22 -84 -15 -105 6 -14 182 -198 392 -409 l382 -382 -145 -145
-145 -145 -387 380 c-212 209 -397 384 -411 389 -19 7 -46 2 -118 -21 -82 -27
-109 -31 -209 -32 -133 -1 -206 15 -316 70 -181 89 -318 261 -370 464 -17 66
-24 253 -11 267 4 4 101 -86 215 -200 190 -190 210 -207 242 -207 32 0 54 20
287 253 234 233 253 255 253 287 0 32 -17 52 -205 240 -113 113 -205 208 -205
212 0 22 180 14 286 -13z m2963 21 c21 0 -7 -32 -187 -213 -178 -179 -212
-218 -212 -242 0 -25 39 -68 257 -287 238 -238 260 -258 292 -258 32 0 52 17
241 205 113 113 209 202 213 199 4 -4 7 -43 7 -86 0 -321 -202 -596 -505 -686
-110 -33 -267 -34 -375 -2 -41 12 -95 24 -120 27 l-46 5 -1032 -1027 c-636
-633 -1035 -1037 -1038 -1052 -4 -16 4 -57 22 -112 26 -78 29 -99 29 -221 0
-125 -3 -141 -31 -221 -73 -206 -239 -371 -440 -438 -78 -26 -213 -43 -281
-34 l-54 6 210 211 c178 179 211 217 211 241 0 25 -38 68 -258 287 -236 237
-260 258 -292 258 -31 0 -52 -18 -241 -207 -202 -200 -208 -205 -215 -178 -9
38 2 171 21 247 9 35 35 101 58 148 33 68 58 102 127 171 70 71 101 94 180
133 54 26 128 53 170 62 105 22 250 14 355 -20 44 -14 91 -26 105 -26 36 0
2100 2063 2100 2099 0 14 -12 59 -27 100 -25 69 -28 89 -28 216 0 131 2 145
31 226 74 208 239 371 444 438 78 26 179 41 239 35 24 -2 55 -4 70 -4z m-830
-2724 c212 -212 395 -387 408 -391 14 -3 52 4 91 18 319 115 662 -7 841 -300
65 -106 108 -293 94 -410 l-6 -55 -206 206 c-161 161 -213 207 -239 212 -33 7
-38 2 -293 -252 -239 -239 -259 -261 -259 -293 0 -32 17 -52 205 -241 113
-113 202 -209 199 -213 -13 -13 -175 -7 -247 9 -40 9 -115 36 -167 61 -79 38
-107 59 -180 132 -195 196 -253 447 -166 720 13 42 21 84 17 96 -3 13 -178
198 -388 412 l-382 389 142 142 c78 78 144 142 147 142 3 0 178 -173 389 -384z"
                />
            </g>
        </svg>
    )
...
function Pilots({className}: {className?: string}) {
    return (
        <svg
            ...
            viewBox="0 0 512.000000 512.000000"
            preserveAspectRatio="xMidYMid meet"
            className={`${className} rotate-y-180`}
        >
